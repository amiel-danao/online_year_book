...
class _SectionsPageWidgetState extends State<SectionsPageWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SectionsPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'sectionsPage'});
    setupAnimations(
                  ...
                  if (responsiveVisibility(
                    ...
                    wrapWithModel(
                      ...
                      child: WebNavWidget(
                        ...
                        textSix: FlutterFlowTheme.of(context).primary,
                        iconSeven: Icon(
                          Icons.golf_course,
                        ),
                        colorBgSix:
