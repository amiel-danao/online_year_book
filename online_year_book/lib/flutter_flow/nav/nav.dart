        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'YearBooksPage',
              path: 'yearBooksPage',
              builder: (context, params) => YearBooksPageWidget(),
            ),
            FFRoute(
              name: 'studentsPage',
              path: 'students',
            ...
            FFRoute(
              ...
              asyncParams: {
                'sectionToEdit':
                    getDoc(['section'], SectionRecord.fromSnapshot),
              },
              builder: (context, params) => CreateSectionWidget(
                sectionToEdit:
                    params.getParam('sectionToEdit', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'sectionsPage',
              path: 'sections',
              requireAuth: true,
              builder: (context, params) => SectionsPageWidget(),
            ),
            FFRoute(
              name: 'coursesPage',
              path: 'courses',
            ...
            FFRoute(
              ...
              requireAuth: true,
              asyncParams: {
                'courseToEdit': getDoc(['course'], CourseRecord.fromSnapshot),
              },
              builder: (context, params) => CreateCourseWidget(
                courseToEdit:
                    params.getParam('courseToEdit', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'CreateStudent',
            ...
            FFRoute(
              ...
              asyncParams: {
                'yearBookToEdit':
                    getDoc(['yearBooks'], YearBooksRecord.fromSnapshot),
              },
